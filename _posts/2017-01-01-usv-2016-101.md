...
<br>![alt text](../2016/USV_2016-v101/imgs/usv-flag1-001.png)
<br><br>

Result was flag1
<br>![alt text](../2016/USV_2016-v101/imgs/usv-flag1-002.png)
<br><br>
...
<br>![alt text](../2016/USV_2016-v101/imgs/usv-wwwforbidden.png)
<br><br>

Running dirb against gave the same error
<br>![alt text](../2016/USV_2016-v101/imgs/usv-dirbfail.png)
<br><br>

Stuck, I remembered that a squid proxy was revealed during the nmap. 
<br>![alt text](../2016/USV_2016-v101/imgs/usv-squid.png)
<br><br>

As always, I run everything through burp suite so I added the proxy setting as an upstream proxy
<br>![alt text](../2016/USV_2016-v101/imgs/usv-upstreamproxy.png)
<br><br>
...
<br>![alt text](../2016/USV_2016-v101/imgs/usv-80allowed.png)
<br><br>
...
<br>![alt text](../2016/USV_2016-v101/imgs/usv-hodor001.png)
<br><br>
...
<br>![alt text](../2016/USV_2016-v101/imgs/usv-hodor002.png)
<br><br>

Moving up one level reveals the message and a download link which turns out to be a zip file
<br>![alt text](../2016/USV_2016-v101/imgs/usv-hodor003.png)
<br>![alt text](../2016/USV_2016-v101/imgs/usv-hodor004.png)
<br><br>

Unzipping the file reveals an image file named hodor and the picture shows an base64 encoded string
<br>![alt text](../2016/USV_2016-v101/imgs/usv-hodor005.png)
<br><br>

Decoding the string reveals flag3
<br>![alt text](../2016/USV_2016-v101/imgs/usv-flag3.png)
<br><br>
...
<br>![alt text](../2016/USV_2016-v101/imgs/usv-secretchapter.png)
<br><br>
...
<br>![alt text](../2016/USV_2016-v101/imgs/usv-cewl.png)
<br><br>

Running the new word list through burp intruder also failed
<br>![alt text](../2016/USV_2016-v101/imgs/usv-burp001.png)
<br>![alt text](../2016/USV_2016-v101/imgs/usv-burp002.png)
<br><br>
...
<br>![alt text](../2016/USV_2016-v101/imgs/usv-post.png)
<br>![alt text](../2016/USV_2016-v101/imgs/usv-get.png)
<br><br>

With that information I setup burp intruder to include redirection and cookies
<br>![alt text](../2016/USV_2016-v101/imgs/usv-burp003.png)
<br><br>
...
<br>![alt text](../2016/USV_2016-v101/imgs/usv-burpsecret.png)
<br><br>

Decoding the string reveals flag4
<br>![alt text](../2016/USV_2016-v101/imgs/usv-flag4.png)
<br><br>
Paraguay Flag: 4761b65f20053674657c7e6186628a29

Tested the password on the actual post and it reveals a picture
<br>![alt text](../2016/USV_2016-v101/imgs/usv-secretexposed.png)
<br><br>
...
<br>![alt text](../2016/USV_2016-v101/imgs/usv-ftp.png)
<br><br>
...
<br>![alt text](../2016/USV_2016-v101/imgs/usv-ftpnote.png)
<br><br>
...
<br>![alt text](../2016/USV_2016-v101/imgs/usv-children.png)
<br><br>

Running the list through wpscan reveals RhaegalDrogonViserion as the password
<br>![alt text](../2016/USV_2016-v101/imgs/usv-wpscanbrute001.png)
<br>![alt text](../2016/USV_2016-v101/imgs/usv-wpscanbrute002.png)
<br><br>

*snippet of wpscan

Now to test those credentials on the site...
<br>![alt text](../2016/USV_2016-v101/imgs/usv-wplogin.png)
<br><br>

and we're in!
<br>![alt text](../2016/USV_2016-v101/imgs/usv-wpadmin.png)
<br><br>

Looking around the site I found the profile section which reveals a base64 encoded string for mother_of_dragons
<br>![alt text](../2016/USV_2016-v101/imgs/usv-wpprofile.png)
<br><br>

Decoding the string reveals flag5
<br>![alt text](../2016/USV_2016-v101/imgs/usv-flag5.png)
<br><br>
...
<br>![alt text](../2016/USV_2016-v101/imgs/usv-wpfooter.png)
<br><br>

Boom!...limited shell as user http
<br>![alt text](../2016/USV_2016-v101/imgs/usv-limitedshell.png)
<br><br>

Lookin at the passwd file, it shows the home directory for http at /srv/http
<br>![alt text](../2016/USV_2016-v101/imgs/usv-passwd.png)
<br><br>
...
<br>![alt text](../2016/USV_2016-v101/imgs/usv-homedir.png)
<br><br>

Decoding the string reveals flag6
<br>![alt text](../2016/USV_2016-v101/imgs/usv-flag6.png)
<br><br>
...
<br>![alt text](../2016/USV_2016-v101/imgs/usv-exec.png)
<br><br>
