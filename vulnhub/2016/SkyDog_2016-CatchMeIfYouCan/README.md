...
<br>![alt text](https://github.com/bzyo/vulnhub/blob/master/2016/SkyDog_2016-CatchMeIfYouCan/imgs/nmap.png)
<br><br>

Flag #2: Obscurity or Security?
Connecting to ssh over port 22222 the banner provides flag 2
<br>![alt text](https://github.com/bzyo/vulnhub/blob/master/2016/SkyDog_2016-CatchMeIfYouCan/imgs/flag02.png)
<br><br>
...
<br>![alt text](https://github.com/bzyo/vulnhub/blob/master/2016/SkyDog_2016-CatchMeIfYouCan/imgs/sslflag3.png)
<br><br>
...
<br>![alt text](https://github.com/bzyo/vulnhub/blob/master/2016/SkyDog_2016-CatchMeIfYouCan/imgs/dirb.png)
<br><br>
...
<br>![alt text](https://github.com/bzyo/vulnhub/blob/master/2016/SkyDog_2016-CatchMeIfYouCan/imgs/403personnel.png)
<br><br>

Running the site through burp suite, the site map shows a directory oldIE and a file html5.js
<br>![alt text](https://github.com/bzyo/vulnhub/blob/master/2016/SkyDog_2016-CatchMeIfYouCan/imgs/burp002.png)
<br><br>
Browsing to the site reveals a comment of a long hex string
<br>![alt text](https://github.com/bzyo/vulnhub/blob/master/2016/SkyDog_2016-CatchMeIfYouCan/imgs/oldIE.png)
<br><br>

When the hex string is converted it reveals flag 1
<br>![alt text](https://github.com/bzyo/vulnhub/blob/master/2016/SkyDog_2016-CatchMeIfYouCan/imgs/flag1.png)
<br><br>
...
<br>![alt text](https://github.com/bzyo/vulnhub/blob/master/2016/SkyDog_2016-CatchMeIfYouCan/imgs/js.png)
<br><br>
...
<br>![alt text](https://github.com/bzyo/vulnhub/blob/master/2016/SkyDog_2016-CatchMeIfYouCan/imgs/agentie4.png)
<br><br>
...
<br>![alt text](https://github.com/bzyo/vulnhub/blob/master/2016/SkyDog_2016-CatchMeIfYouCan/imgs/newevidence001.png)
<br><br>
...
<br>![alt text](https://github.com/bzyo/vulnhub/blob/master/2016/SkyDog_2016-CatchMeIfYouCan/imgs/intruder01.png)
<br><br>

Payload Sets: 
Set payload type to custom iterator
<br>![alt text](https://github.com/bzyo/vulnhub/blob/master/2016/SkyDog_2016-CatchMeIfYouCan/imgs/intruder02.png)
<br><br>

Payload Options: 
Set position one to be the username and add a colon separator
<br>![alt text](https://github.com/bzyo/vulnhub/blob/master/2016/SkyDog_2016-CatchMeIfYouCan/imgs/intruder03.png)
<br><br>

Set position two for word lists (my usual are big & names)
<br>![alt text](https://github.com/bzyo/vulnhub/blob/master/2016/SkyDog_2016-CatchMeIfYouCan/imgs/intruder4.png)
<br><br>

Payload Processing:
Add processing rule to base64 encode the payload
<br>![alt text](https://github.com/bzyo/vulnhub/blob/master/2016/SkyDog_2016-CatchMeIfYouCan/imgs/intruder5.png)
<br><br>

Payload Encoding:
Be sure to remove the equal sign
<br>![alt text](https://github.com/bzyo/vulnhub/blob/master/2016/SkyDog_2016-CatchMeIfYouCan/imgs/intruder6.png)
<br><br>

Now go grab some popcorn…and after some time a 301 status appears. 
<br>![alt text](https://github.com/bzyo/vulnhub/blob/master/2016/SkyDog_2016-CatchMeIfYouCan/imgs/intruder7.png)
<br><br>

After a quick base64 decode it shows the password is Grace
<br>![alt text](https://github.com/bzyo/vulnhub/blob/master/2016/SkyDog_2016-CatchMeIfYouCan/imgs/preflag5.png)
<br><br>

Using these credentials allows access to the web page which has three links.
<br>![alt text](https://github.com/bzyo/vulnhub/blob/master/2016/SkyDog_2016-CatchMeIfYouCan/imgs/newevidence002.png)
<br><br>

First link is to a text file revealing flag 5, second link is an image file and the third is a pdf file.
<br>![alt text](https://github.com/bzyo/vulnhub/blob/master/2016/SkyDog_2016-CatchMeIfYouCan/imgs/flag5.png)
<br><br>
...
<br>![alt text](https://github.com/bzyo/vulnhub/blob/master/2016/SkyDog_2016-CatchMeIfYouCan/imgs/binwalk.png)
<br><br>
...
<br>![alt text](https://github.com/bzyo/vulnhub/blob/master/2016/SkyDog_2016-CatchMeIfYouCan/imgs/preflag6.png)
<br><br>

The extracted text files reveals both the encoded and decoded flag 6 with an additional clue
<br>![alt text](https://github.com/bzyo/vulnhub/blob/master/2016/SkyDog_2016-CatchMeIfYouCan/imgs/flag6.png)
<br><br>
...
<br>![alt text](https://github.com/bzyo/vulnhub/blob/master/2016/SkyDog_2016-CatchMeIfYouCan/imgs/preflag7.png)
<br><br>

Available files are a flag text files, which reveals flag 7, and an unknown file with a .data extension.
<br>![alt text](https://github.com/bzyo/vulnhub/blob/master/2016/SkyDog_2016-CatchMeIfYouCan/imgs/flag7.png)
<br><br>
...
<br>![alt text](https://github.com/bzyo/vulnhub/blob/master/2016/SkyDog_2016-CatchMeIfYouCan/imgs/data001.png)
<br><br>

Unzipping the file expands it to a 1GB file, which shows that it’s a data file. 
<br>![alt text](https://github.com/bzyo/vulnhub/blob/master/2016/SkyDog_2016-CatchMeIfYouCan/imgs/data002.png)
<br><br>
...
<br>![alt text](https://github.com/bzyo/vulnhub/blob/master/2016/SkyDog_2016-CatchMeIfYouCan/imgs/preflag8.png)
<br><br>
...
<br>![alt text](https://github.com/bzyo/vulnhub/blob/master/2016/SkyDog_2016-CatchMeIfYouCan/imgs/flag8.png)
<br><br>
